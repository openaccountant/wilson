 ...
 * Stores messages in .openspend/messages/chat_history.json
 */
export class LongTermChatHistory {
  ...
  constructor(baseDir: string = process.cwd()) {
    this.filePath = join(baseDir, OPENSPEND_DIR, MESSAGES_DIR, MESSAGES_FILE);
  }
